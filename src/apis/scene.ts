...
import { APIMetadataPagination, Scenario, ScenarioDTO } from "../types";
...
export function useInfiniteScenarios(
  queryParams: QueryParams
): ResponseInfiniteData {
  ...
  return useMemo<ResponseInfiniteData>((): ResponseInfiniteData => query, [
    query
  ]);
}
